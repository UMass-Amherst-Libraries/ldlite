...
queries = [
    ('courses.coursereserves_copyrightstates', '/coursereserves/copyrightstatuses', allrec),
    ('courses.coursereserves_courselistings', '/coursereserves/courselistings', allrec),
    ('courses.coursereserves_courses', '/coursereserves/courses', allrec),
    ('courses.coursereserves_coursetypes', '/coursereserves/coursetypes', allrec),
    ('courses.coursereserves_departments', '/coursereserves/departments', allrec),
    ('courses.coursereserves_processingstates', '/coursereserves/processingstatuses', allrec),
    ('courses.coursereserves_reserves', '/coursereserves/reserves', allrec),
    ('courses.coursereserves_roles', '/coursereserves/roles', allrec),
    ('courses.coursereserves_terms', '/coursereserves/terms', allrec),
    ]
...
for q in queries:
    try:
        ...
        print('course.py: error processing "' + q[1] + '"', file=sys.stderr)
print()
print('Tables:')
for t in tables:
    print(t)
