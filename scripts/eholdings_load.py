...
db = ld.connect_db_postgresql(dsn='dbname=ldplite host=localhost user=ldplite password=saltldplite')
...
queries = [
    ('eholdings.access_types', '/eholdings/access-types', allrec),
    ('eholdings.', '/eholdings/access-types', allrec),
    ('eholdings.access_types', '/eholdings/access-types', allrec),
    ('eholdings.access_types', '/eholdings/access-types', allrec),
    ('eholdings.access_types', '/eholdings/access-types', allrec),
    ]
