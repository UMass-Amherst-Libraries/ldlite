...
ld.connect_okapi(url='', tenant='', user='', password='i am not going to tell you')
...
queries = [
    ('finance.budget', '/finance-storage/budgets', allrec),
    ('finance.expense_class', '/finance-storage/expense-classes', allrec),
    ('finance.fiscal_year', '/finance-storage/fiscal-years', allrec),
    ('finance.fund', '/finance-storage/funds', allrec),
    ('finance.fund_type', '/finance-storage/fund-types', allrec),
    ('finance.group_fund_fiscal_year', '/finance-storage/group-fund-fiscal-years', allrec),
    ('finance.groups', '/finance-storage/groups', allrec),
    ('finance.ledger', '/finance-storage/ledgers', allrec),
    ('finance.transaction', '/finance-storage/transactions', allrec),    ('finance.budget', '/finance-storage/budgets', allrec),
    ('finance.expense_class', '/finance-storage/expense-classes', allrec),
    ('finance.fiscal_year', '/finance-storage/fiscal-years', allrec),
    ('finance.fund', '/finance-storage/funds', allrec),
    ('finance.fund_type', '/finance-storage/fund-types', allrec),
    ...
    ('finance.groups', '/finance-storage/groups', allrec),
    ('finance.ledger', '/finance-storage/ledgers', allrec),
    ('finance.transaction', '/finance-storage/transactions', allrec),
    ]
