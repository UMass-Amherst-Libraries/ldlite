...
queries = [
    ('feesfines.accounts', '/accounts', allrec),
    ('feesfines.comments', '/comments', allrec),
    ('feesfines.feefineactions', '/feefineactions', allrec),
    ('feesfines.feefines', '/feefines', allrec),
    ('feesfines.lost_item_fee_policy', '/lost-item-fees-policies', allrec),
    ('feesfines.manualblocks', '/manualblocks', allrec),
    ('feesfines.overdue_fine_policy', '/overdue-fines-policies', allrec),
    ('feesfines.owners', '/owners', allrec),
    ('feesfines.payments', '/payments', allrec),
    ('feesfines.refunds', '/refunds', allrec),
    ('feesfines.transfer_criteria', '/transfer-criterias', allrec),
    ('feesfines.transfers', '/transfers', allrec),
    ('feesfines.waives', '/waives', allrec),
    ]
