...
queries = [
    ('invoice.invoice_lines', '/invoice/invoice-lines', allrec),
    ('invoice.invoices', '/invoice/invoices', allrec),
    ('invoice.batch_groups', '/batch-groups', allrec),
    ('invoice.batch_voucher_exp', '/batch-voucher/batch-voucher-exports', allrec),
