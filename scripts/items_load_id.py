...
queries = [
    ('inventory.item0', '/item-storage/items', 'id=0* sortby id', 0),
    ('inventory.item1', '/item-storage/items', 'id=1* sortby id', 0),
    ('inventory.item2', '/item-storage/items', 'id=2* sortby id', 0),
    ('inventory.item3', '/item-storage/items', 'id=3* sortby id', 0),
    ('inventory.item4', '/item-storage/items', 'id=4* sortby id', 0),
    ('inventory.item5', '/item-storage/items', 'id=5* sortby id', 0),
    ('inventory.item6', '/item-storage/items', 'id=6* sortby id', 0),
    ('inventory.item7', '/item-storage/items', 'id=7* sortby id', 0),
    ('inventory.item8', '/item-storage/items', 'id=8* sortby id', 0),
    ('inventory.item9', '/item-storage/items', 'id=9* sortby id', 0),
    ('inventory.itema', '/item-storage/items', 'id=a* sortby id', 0),
    ('inventory.itemb', '/item-storage/items', 'id=b* sortby id', 0),
    ('inventory.itemc', '/item-storage/items', 'id=c* sortby id', 0),
    ('inventory.itemd', '/item-storage/items', 'id=d* sortby id', 0),
    ('inventory.iteme', '/item-storage/items', 'id=e* sortby id', 0),
    ('inventory.itemf', '/item-storage/items', 'id=f* sortby id', 0)
