...
queries = [
    ('users.addresstype', '/addresstypes', allrec),
    ('users.departments', '/departments', allrec),
    ('users.groups', '/groups', allrec),
    ('users.proxyfor', '/proxiesfor', allrec),
    ('users.users', '/users', allrec),
    ]
